...
public static class Scenario
{
    ...
    /// 数值为占位,用于验证 建军 / 全雾 / 任务判定;混编 combat 归 M-A。
    /// </summary>
    public static Simulation FirstBattleBlackPine(DifficultySettings? difficulty = null, int seed = 20250629)
    {
        ...
        SeedOwnBelief(sim, Side.Friend);
        SeedOwnBelief(sim, Side.Enemy);
        sim.Mission = Missions.BlackPine();
        return sim;
    }
